...
function(GenerateHeader UnitDir UnitType OutputDir)
    set(json "{}")
    ...
    string(JSON json SET "${json}" "header" "version"   "\"1.0-0\"")
...
function(GenerateModFx UnitName Includes Source)
    set(UnitDir ${CMAKE_BINARY_DIR}/LogueSdk/platform/minilogue-xd/${UnitName})
    GenerateKorgUnit("${UnitDir}" "${UnitName}" "${Includes}" "${Source}")
    GenerateHeader("${UnitName}" "modfx" "${UnitDir}")
...
function(GenerateRevFx UnitName Includes Source)
    set(UnitDir ${CMAKE_BINARY_DIR}/LogueSdk/platform/minilogue-xd/${UnitName})
    GenerateKorgUnit("${UnitDir}" "${UnitName}" "${Includes}" "${Source}")
    GenerateHeader("${UnitDir}" "revfx" "${UnitDir}")
